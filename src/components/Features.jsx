            ...
            <div className='flex justify-center items-center '>
                <div className='flex flex-row flex-wrap gap-10 justify-center items-center'>
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            <p className='text-xl font-sans dont-semibold change-bold my-2'>Sharing Made Easy</p>
                    ...
                    <div className='flex flex-col justify-center items-center text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            <p className='text-xl font-sans dont-semibold change-bold my-2'>Hassle-free Transactions</p>
                    ...
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            <p className='text-xl font-sans dont-semibold change-bold my-2'>Gamification Done Right</p>
                    ...
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            <p className='text-xl font-sans dont-semibold change-bold my-2'>Decentralized And Secure</p>
                    ...
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 mt-12'>
                        ...
                        <div className='w-96'>
                            <p className='text-xl font-sans dont-semibold change-bold my-2 py-2'>Open Sourced and 5ire Oriented</p>
