...
export default function Features() {
    return (
        <section className='container mx-auto my-12 md:my-4 md:gradient md:px-auto px-10 md:text-white min-h-max py-12 md:rounded-tr-[5rem] md:rounded-tl-[5rem] overflow-hidden'>
                ...
                <div className='flex flex-row flex-wrap gap-10 justify-center items-center'>
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            ...
                            <p className='text-lg'>Say goodbye to long and unreadable 5ire addresses. Share your .5ire names with a click.</p>
                        </div>
                    </div>
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            ...
                            <p className='text-lg'>Sending and receiving payments just got easier, .5ire names enable hassle-free transactions.</p>
                        </div>
                    </div>
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            ...
                            <p className='text-lg'>Create engaging and rewarding experiences leveraging 5NS gamification mechanisms.</p>
                        </div>
                    </div>
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 gap-4'>
                        ...
                        <div className='w-96'>
                            ...
                            <p className='text-lg'>Your keys, Your .5ire Names. Have true ownership of your NFT&apos;s just like owning your cryptocurrencies.
                            </p>
                        </div>
                    </div>
                    <div className='flex flex-col text-center flex-wrap md:p-3 px-10 mt-12'>
                        ...
                        <div className='w-96'>
                            ...
                            <p className='text-lg'>.5ire names are stored on the 5ire chain network. Audited, open source smart contracts ensure that sending funds to a .5ire name is as secure as sending to a regular address.
                            </p>
                        </div>
                    </div>
                </div>
